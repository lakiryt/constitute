...
export default function Header({ structure }: { structure: ConstitutionStructure }) {
  ...
  return (
    <>
      ...
      {visible && showTOC && (
        <div className="fixed left-1/2 top-20 transform -translate-x-1/2 z-40 bg-white/95 rounded-2xl shadow-xl px-8 py-6 w-[min(90vw,900px)] max-h-[60vh] overflow-y-auto border border-gray-200">
